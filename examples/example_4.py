...
print("N. Iterations:", sol_nscore.epochs)
print("Solution x:", sol_nscore.x)
print("Objective values:", sol_nscore.obj[-1])
print("Function values:", sol_nscore.fval[-1])
print("gradient norms:", sol_nscore.grad_norms[-1])
print("=" * 50)
print("ProxGGNSCORE (Sparse Logistic Regression):")
print("N. Iterations:", sol_ggn.epochs)
print("Solution x:", sol_ggn.x)
print("Objective values:", sol_ggn.obj[-1])
print("Function values:", sol_ggn.fval[-1])
print("gradient norms:", sol_ggn.grad_norms[-1])
print("=" * 50)
